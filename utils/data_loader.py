...
class Dataset(data.Dataset):
    ...
    def __init__(self, csv_path, use_cleaned=True, use_embedding="None", embedding_dim=300):
        """
        ...
        if use_embedding == "None":
            ...
            self._vocab = self._build_rnd_vocab(self.textProcesser, self.df, dim=embedding_dim)
        else:
